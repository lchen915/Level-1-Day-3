...
public class SimonSays extends KeyAdapter {
 ...
 // 2. add 4 images which match keyboard keys like this: images.put(new Integer(KeyEvent.VK_UP), "image.jpg");
 	images.put(new Integer(KeyEvent.VK_UP), "up key.png");
 	images.put(new Integer(KeyEvent.VK_DOWN), "down key.jpeg");
 	images.put(new Integer(KeyEvent.VK_LEFT), "left key.png");
 	images.put(new Integer(KeyEvent.VK_RIGHT), "right key.png");
